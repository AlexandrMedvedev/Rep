        ...
        {if $product}
            ...
            <div class="ty-product-block__left">
                ...
                {if $capture_options_vs_qty}{capture name="product_options"}{$smarty.capture.product_options nofilter}{/if}
                     ...
                     <!--Календарь доступности и материал-->         
...
<input type="hidden" name="appearance[show_my_material]" value="{$show_my_material}" />
<label class="ty-control-group__label" id="my_material_{$obj_prefix}{$obj_id}">{__("my_material")}:</label>
<span class="ty-control-group__item cm-reload-{$obj_prefix}{$obj_id}" id="product_code_{$obj_prefix}{$obj_id}">{$product.my_material}<!--product_code_{$obj_prefix}{$obj_id}--></span>
</div>
   
   <div class="ty-control-group ty-sku-item cm-hidden-wrapper{if !$product.product_code} hidden{/if}" id="sku_update_{$obj_prefix}{$obj_id}">
<input type="hidden" name="appearance[show_my_available]" value="{$show_my_material}" />
<label class="ty-control-group__label" id="my_available_{$obj_prefix}{$obj_id}">{__("my_available")}:</label>
<span class="ty-control-group__item cm-reload-{$obj_prefix}{$obj_id}" id="product_code_{$obj_prefix}{$obj_id}">{$product.my_available}<!--product_code_{$obj_prefix}{$obj_id}--></span>
</div>
                ...
                <div class="ty-product-block__field-group">
                    ...
                    {$smarty.capture.$min_qty nofilter}
                     ...
                     <!-- Комментарии -->
                       <div class="ty-control-group ty-sku-item cm-hidden-wrapper{if !$product.product_code} hidden{/if}" id="sku_update_{$obj_prefix}{$obj_id}">
<input type="hidden" name="appearance[show_my_comments]" value="{$show_my_comments}" />
<label class="ty-control-group__label" id="my_comments_{$obj_prefix}{$obj_id}">{__("my_comments")}:</label>
<span class="ty-control-group__item cm-reload-{$obj_prefix}{$obj_id}" id="product_code_{$obj_prefix}{$obj_id}">{$product.my_comments}<!--product_code_{$obj_prefix}{$obj_id}--></span>
</div>
